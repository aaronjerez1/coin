...
//     int nVersion;
//     uint256 hashTo;
//     std::map<string, string> mapValue;
...
//     CAddress addr;
//     std::map<string, string> mapValue;
//     std::map<string, string> mapDetails;
...
// extern std::map<uint256, CProduct> mapProducts;
// extern CCriticalSection cs_mapProducts;
// extern std::map<uint256, CProduct> mapMyProducts;

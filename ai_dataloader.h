#ifndef AI_DATALOADER_H
#define AI_DATALOADER_H
/*
Implements:
...
typedef struct {
    ...
    int should_shuffle; // what is this
    int* shard_indices;
...
inline int64_t dataloader_load_shard_(DataLoader *loader, int shard_index) {
...
inline void prepare_intra_shard_indices_(DataLoader *loader) {
...
inline void dataloader_reset(DataLoader *loader) {
...
inline void dataloader_advance_(DataLoader *loader) {
...
inline void dataloader_init(DataLoader *loader,
...
// inline void dataloader_load_block(DataLoader* loader, const unnamed2& block){
...
//     auto buffer = encoder.encode(block_string);
...
void dataloader_load_batch(DataLoader* loader) {
    ...
    for (int i = 0; i < B*T; i++) { // thisis what you want
        loader->inputs[i] = (int)loader->buffer[i];
        loader->targets[i] = (int)loader->buffer[i+1];
    }
}

// void dataloader_next_batch(DataLoader *loader, const unnamed2& block) {
